...
**Tutorials**:
- Minimal parallel processing tutorial (no API keys needed)
- Interactive notebook for individual tool demos
- FastAPI server exposing agents as a REST API + example client
